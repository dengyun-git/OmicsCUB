...
for tP=1:length(speciesName)
    ...
    fileName1=[speciesName{tP},'ForFgTp.txt'];
    %     fileName1=[speciesName{tP},'ForPtTp.txt'];
    ...
    fileName2=[speciesName{tP},'ForFgT.txt']; %%%%write to this temperature file codon table replacement
    %     fileName2=[speciesName{tP},'ForPtT.txt'];
